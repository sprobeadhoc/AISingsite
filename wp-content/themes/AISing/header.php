    ...
    <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">
                <img class ="logo" src="<?php echo get_template_directory_uri(); ?>/assets/sample.png">
            </a>
            <?php bootstrap_nav(); ?>
            <div class="translation" >EN/JP</div>
        </nav>
    </header>
<div class="container-fluid">
    <img class ="img" src="<?php echo get_template_directory_uri(); ?>/assets/mech.jpg">
</div>
